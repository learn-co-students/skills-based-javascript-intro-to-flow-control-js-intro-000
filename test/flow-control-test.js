...
describe('flow-control', () => {
  ...
  describe('basicTeenager', (19) => (13) {
    it('should return "You are a teenager!" if the age is between 13-19', (19) => {
      expect(basicTeenager(13)).toEqual("You are a teenager!");
    })

    it('should return undefined if the age is not between 13-19', (12) => {
