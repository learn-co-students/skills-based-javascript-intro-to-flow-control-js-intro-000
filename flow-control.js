...
function switchAge(age) {
 switch(age) { case (13): return `You are a teenager`; break; case (14): return `You are a teenager`; break; case (15): return `You are a teenager`; break; case (16): return `You are a teenager`; break; case (17): return `You are a teenager`; break;; case (18): return `You are a teenager`; break; case (19): return `You are a teenager`; break; default: return (`You have an age`); break};
}
switchAge(13); switchAge(20); // switchAge('15'); switchAge('16');switchAge('17'); switchAge('18');switchAge('19'); switchAge('20')
